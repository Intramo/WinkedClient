...
function onLogin() {
    ...
    if (!wrong) {
        buildInitialWebsocketConnection();
...
var connection = null;
var hasBuildWebsocketConnection = false;

function buildInitialWebsocketConnection(){
    if(hasBuildWebsocketConnection) return;
    connection = new WebSocket("wss://"+serverHost+"/");
    hasBuildWebsocketConnection = true;
